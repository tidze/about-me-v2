...
<body>
    ...
    <div id="main-content-container">
        ...
        <p>Last Update: August 26, 2020</p>
        <p><strong>What is the Epic Games Store?</strong><br>
            The Epic Games Store is a curated digital storefront for PC and Mac, designed with both players and creators
            in mind. It’s focused on providing great games for
            gamers, and a fair deal for game developers. When you buy a game on the Epic Games Store, 88% of the price
            goes directly to developers, versus only 70% on many
            other stores. This helps developers invest into building bigger and better games.</p>
        <p><strong>Where can I download the Epic Games Store?</strong><br>
            Visit the Epic Games Store page at <a href="epicgames.com">epicgames.com</a>, go to the upper right corner,
            and click “Get Epic Games.” This is the only place to
            safely download the
            installer for the Epic Games Store. Do not trust other sources, as they are likely unsafe.</p>
        <p><strong>Which platforms does the Epic Games Store support?</strong><br>
            The Epic Games Store currently offers PC and Mac support. You can check platform compatibility for
            individual titles by referring to the “About Game” section of
            any product page.</p>
        <p><strong>What are the future plans for the Epic Games Store?</strong><br>
            You can find upcoming features, developer updates, and major known issues on our <a href="">Epic Games Store
                Roadmap</a> on Trello. We’ll also share significant updates with you
            on our <a href="">news feed</a> and social media pages such as <a href="Facebook.com">Facebook</a>, <a
                href="twitter.com">Twitter</a>, <a href="instagram.com">Instagram</a>, and
            YouTube. </p>
        <p><strong>Why does the Epic Games Store make exclusivity deals?</strong><br>
            Exclusives are a part of the growth of many successful platforms for games and for other forms of digital
            entertainment, such as streaming video and music. <br><br>
            Epic works in partnership with developers and publishers to offer games exclusively on the store. In
            exchange for exclusivity,
            Epic provides them with financial support for development and marketing, which enables them to build more
            polished games with
            significantly less uncertainty for the creators.<br><br>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <p dir="ltr"><strong><span style="font-size:14px">Country or Territory Name</span></strong></p>
                    </td>
                    <td>
                        <p dir="ltr"><strong><span style="font-size:14px">Currency</span></strong></p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Afghanistan</span></p>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Aland Islands</span></p>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Albania</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">EUR</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">American Samoa</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Israel</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">ILS</span></p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Italy</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">EUR</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Japan</span></p>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Kazakhstan</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Korea (South)</span></p>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Kuwait</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Kyrgyzstan</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Liechtenstein</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">CHF</span></p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">US Minor Outlying Islands</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Uzbekistan</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Vanuatu</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Venezuela (Bolivarian Republic)</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Vietnam</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Virgin Islands, US</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Wallis and Futuna Islands</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Western Sahara</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Yemen</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Zambia</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
                ...
                <tr>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">Zimbabwe</span></p>
                    </td>
                    <td>
                        <p dir="ltr"><span style="font-size:14px">USD</span></p>
                    </td>
    ...
    <div class="footer">
        <div class="svg-container social">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60.734px"
                height="60.733px" viewBox="0 0 60.734 60.733" style="enable-background:new 0 0 60.734 60.733;"
                xml:space="preserve">
                <g>
                    <path
  ...
  v5.851h9.078l-1.187,9.166h-7.892v23.52h15.475c1.852,0,3.355-1.503,3.355-3.351V3.351C60.731,1.5,59.23,0.001,57.378,0.001z" />
        ...
        <div class="svg-container arrow">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="451.846px"
                height="451.847px" viewBox="0 0 451.846 451.847" style="enable-background:new 0 0 451.846 451.847;"
                xml:space="preserve">
                <g>
  ...
  c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z" />
        ...
        <p>
            ...
            in the United States of America and elsewhere. Other brands or product names are the trademarks of their
            respective owners.
